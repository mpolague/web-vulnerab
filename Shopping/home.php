...
<div class = "login" style="float: right;">
    ...
    <input type="button" value="Create Account" onclick="window.location.href='/ARMY_PDE_SHOPPING/Shopping/createaccount.php'" style="float: left;  margin-right:50px; margin-top:20px; bottom-margin: 20px;">
    <input type="button" value="Log In" onclick="window.location.href='/ARMY_PDE_SHOPPING/Shopping/loginpage.php'" style="float: right; right-margin: 20px; margin-right:20px; margin-top:20px;">
