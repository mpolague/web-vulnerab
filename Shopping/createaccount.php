...
<div class = "login" style="float: right;">
    ...
    <input type="button " value="Already have an account? Login"  onclick="window.location.href='/ARMY_PDE_SHOPPING/Shopping/loginpage.php'" style="float: left;  margin-right:50px; margin-top:20px; bottom-margin: 20px;">
